...
WeaveCrypto.prototype = {
    ...
    initNSS : function() {
        ...
        var nsslib;
//@line 140 "c:\builds\moz2_slave\tb-rel-c-esr38-w32_bld-0000000\build\mozilla\services\crypto\modules\WeaveCrypto.js"
        let file = Services.dirsvc.get("GreBinD", Ci.nsILocalFile);
        file.append(path);
        this.log("Trying NSS library with path " + file.path);
        nsslib = ctypes.open(file.path);
//@line 145 "c:\builds\moz2_slave\tb-rel-c-esr38-w32_bld-0000000\build\mozilla\services\crypto\modules\WeaveCrypto.js"
